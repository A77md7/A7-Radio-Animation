...
Please report any issues you have in the GitHub [Issues](https://github.com/AvarianKnight/A7-voice/issues)
...
Please do not override `NetworkSetTalkerProximity`, `MumbleSetTalkerProximity`, `MumbleSetAudioInputDistance`, `MumbleSetAudioOutputDistance` or `NetworkSetVoiceActive` in any of your other scripts as there have been cases where it breaks A7-voice.
...
### PLEASE NOTE: Any keybind changes only affect new players, if you want to change your key bind go to Key Bindings -> FiveM -> Look for keybinds under 'A7-voice'.
...
A7-voice comes with a built in /muteply (tgtPly) (duration) command, in order to allow your staff to use it you will have to grand them the ace!
...
|--------------------------|--------------------------------------------------------------|----------------|
| [A7-voice:settingsCallback](docs/client-getters/events.md) | When emited it will return the current A7-voice settings. | cb(voiceSettings) |
| [A7-voice:radioActive](docs/client-getters/events.md) | Triggered when the radio is activated / deactivated | boolean |
| [A7-voice:setTalkingMode](docs/client-getters/events.md) | Triggered on proximity mode change with the voice mode id | int |
